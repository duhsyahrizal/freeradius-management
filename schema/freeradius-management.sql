...
--
-- Dumping data for table `bayhost_users`
--
...
CREATE TABLE `billing_package` (
  ...
  `limit_upload` bigint(20) DEFAULT NULL,
  `limit_download` bigint(20) DEFAULT NULL,
  `billing_type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `bill_report` (
  ...
  `payment` int(2) DEFAULT NULL COMMENT '1=cash,2=gratis,3=transfer,4=hutang',
  `billing_package_id` int(11) NOT NULL,
...
(1, 'Cash', 'Pembayaran dilakukan di admin bayhost'),
...
CREATE TABLE `role_group` (
  ...
  `manage_package` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `role_group` (`role_group_id`, `role_name`, `manage_user`, `manage_package`) VALUES
(1, 'admin', 1, 1),
(2, 'operator', 1, 0),
(3, 'teknisi', 0, 0);
...
CREATE TABLE `user_billing` (
  ...
  `billing_package_id` int(11) NOT NULL,
  `shared_users` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bill_price` int(11) NOT NULL,
  `fullname` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `birthdate` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `boarding_house_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telp` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `start_from` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `end_until` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `billing_package`
--
...
ALTER TABLE `bill_report`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_to_payment_method` (`payment`);
